...
EditLink.prototype.createDom = function(){
    var element = $('<a></a>');
    element.addClass('edit btn btn-default');
    this.decorate(element);
};
...
EditLink.prototype.decorate = function(element){
    ...
    this._element.prepend($('<span class="glyphicon glyphicon-edit"></span>'));
    this.setHandlerInternal();
};
...
CommentConvertLink.prototype.createDom = function() {
    var element = $('<a></a>');
    element.addClass('postable btn btn-default');
    element.data('field-name', 'comment_id');
    element.data('field-value', this._comment_id);
    element.attr('href', askbot['urls']['convertComment'])
    this.decorate(element);
};
...
DeleteIcon.prototype.decorate = function(element){
    this._element = element;
    this._element.addClass('close');
    this._element.attr('title', this._title);
    this._element.attr('aria-hidden', 'true');
    this._element.html('&times;');
...
DeleteIcon.prototype.createDom = function(){
    this._element = $('<button type="button">&times;</button>');
